...
const cspHeader = `
  ...
  connect-src 'self' https://www.obvoso.site https:${devHttp}${devWs};
  img-src 'self' https://*.s3.amazonaws.com https://www.obvoso.site/_next/image data: blob: https:${devHttp};
